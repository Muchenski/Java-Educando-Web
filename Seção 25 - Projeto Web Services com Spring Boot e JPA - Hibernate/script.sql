...
--
-- Name: tb_phone; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: tb_phone fkjjbcywxyw2amay8m6ow0t9yxj; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_phone
    ADD CONSTRAINT fkjjbcywxyw2amay8m6ow0t9yxj FOREIGN KEY (user_id) REFERENCES public.tb_user(id);
